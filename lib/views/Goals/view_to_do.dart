...
class ViewData extends StatefulWidget {
  ViewData({Key? key, required this.taskModel}) : super(key: key);
...
class _ViewDataState extends State<ViewData> {
  ...
  void initState() {
    ...
    String title = widget.taskModel.title;

    _titlecontroller = TextEditingController(text: title);

    String description = widget.taskModel.description;

    _description = TextEditingController(text: description);

    type = widget.taskModel.task;

    category = widget.taskModel.category;

    dateText = widget.taskModel.description;
  }
